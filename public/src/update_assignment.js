var TutAssignment = React.createClass({
    ...
    render: function(){
        ...
        <div id="tut-assignment-container">
          <form id="assign" onSubmit={this.handleSubmit}>
            <label>Enter a course code </label>
            <input type="text" ref="code" placeholder="e.g.EE4483" required />
            <label>Enter a class type </label>
            <input type="text" ref="type" placeholder="e.g.TUT" required />
            <label>Enter a course group </label>
            <input type="text" ref="group" placeholder="e.g.FC1" required />
            <label>Enter a teaching staff name </label>
            <input type="text" ref="name" placeholder="e.g.CLH" required />
            <input type="submit" value="Assign a teaching staff" />
          </form>
          <div>
            {course.title}
          </div>
...
ReactDOM.render(<TutAssignment />, document.getElementById('tutassignments'));